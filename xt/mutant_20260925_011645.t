...
# Source:  # Spill path: fetch rows using filter-only criteria.  Query-time
# Hint:    Likely missing edge-case test (boundary value)
...
# Source:  # Executed BEFORE ORDER BY / LIMIT / OFFSET because they are irrelevant here —
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip > to <
#   Numeric boundary flip > to >=
