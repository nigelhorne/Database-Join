...
# --- SURVIVOR: BOOL_NEGATE_1497_2 (MEDIUM) line 1497 in AUTOLOAD() ---
# Source:  return $db->$col(@_);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1497_2 line 1497 in AUTOLOAD()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Join requires constructor arguments, add them here.
    my $obj = new_ok('Database::Join');
    # TODO: exercise line 1497 in AUTOLOAD() to detect the mutant
    fail('BOOL_NEGATE_1497_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1758_3 (MEDIUM) line 1758 in _msg() ---
# Source:  return $i18n->translate($key, @args);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1758_3 line 1758 in _msg()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Join requires constructor arguments, add them here.
    my $obj = new_ok('Database::Join');
    # TODO: exercise line 1758 in _msg() to detect the mutant
    fail('BOOL_NEGATE_1758_3: replace with real assertion');
}
...
# --- LOW HINT: RETURN_UNDEF_1497_2 line 1497 in AUTOLOAD() ---
# Source:  return $db->$col(@_);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Database::Join requires constructor arguments, add them here.
# my $obj = new_ok('Database::Join');
# ok($obj->..., 'RETURN_UNDEF_1497_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_1758_3 line 1758 in _msg() ---
# Source:  return $i18n->translate($key, @args);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If Database::Join requires constructor arguments, add them here.
# my $obj = new_ok('Database::Join');
# ok($obj->..., 'RETURN_UNDEF_1758_3: add assertion here');
