...
# --- SURVIVOR: BOOL_NEGATE_943_2 (MEDIUM) line 943 in columns() ---
# Source:  return $self->{_col_cache} if $self->{_col_cache};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_943_2 line 943 in columns()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Join requires constructor arguments, add them here.
    my $obj = new_ok('Database::Join');
    # TODO: exercise line 943 in columns() to detect the mutant
    fail('BOOL_NEGATE_943_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_1017_3 (MEDIUM) line 1017 in schema() ---
# Source:  if ($local_jc && $local_jc ne $self->{_join_col}) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1017_3 line 1017 in schema()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Join requires constructor arguments, add them here.
    my $obj = new_ok('Database::Join');
    # TODO: exercise line 1017 in schema() to detect the mutant
    fail('COND_INV_1017_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1070_2 (MEDIUM) line 1070 in updated() ---
# Source:  return max(map { $_->updated() } @{ $self->{_dbs} });
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1070_2 line 1070 in updated()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Join requires constructor arguments, add them here.
    my $obj = new_ok('Database::Join');
    # TODO: exercise line 1070 in updated() to detect the mutant
...
# --- SURVIVOR: COND_INV_1286_2 (MEDIUM) line 1286 in add_database() ---
# Source:  if (my $log = $self->{_logger}) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1286_2 line 1286 in add_database()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Join requires constructor arguments, add them here.
    my $obj = new_ok('Database::Join');
    # TODO: exercise line 1286 in add_database() to detect the mutant
    fail('COND_INV_1286_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1515_2 (MEDIUM) line 1515 in AUTOLOAD() ---
# Source:  return $db->$col(@_);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1515_2 line 1515 in AUTOLOAD()';
    # NOTE: new() called with no arguments as a starting point.
    # If Database::Join requires constructor arguments, add them here.
    my $obj = new_ok('Database::Join');
    # TODO: exercise line 1515 in AUTOLOAD() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_943_2 line 943 in columns() ---
# Source:  return $self->{_col_cache} if $self->{_col_cache};
...
# --- LOW HINT: RETURN_UNDEF_1070_2 line 1070 in updated() ---
# Source:  return max(map { $_->updated() } @{ $self->{_dbs} });
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1515_2 line 1515 in AUTOLOAD() ---
# Source:  return $db->$col(@_);
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
